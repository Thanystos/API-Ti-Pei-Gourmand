        ...
        try {
            ...
            if (!$entityToUpdate) {
                throw new RuntimeException(
                    sprintf(
                        'L\'entité avec l\'id %d n\'existe pas.',
                        $idUpdatedEntity
                    ),
            ...
            if ($processImage) {
                ...
                if (isset($uniqueField[$entityClassName])) {
                    ...
                    if (method_exists($updatedEntity, $getUniqueFieldMethod)) {
                        ...
                        if ($uniqueFieldValue == $entityToUpdate->$getUniqueFieldMethod()) {
                            ...
                            /*
                                Modifie temporairement la valeur du champ unique pour éviter
                                les problèmes d'unicité dans la validation
                            */
                ...
                foreach ($properties as $property) {
                    // Permet de récup les valeurs de prop private avec getValue sans utiliser les setters et getters
                    ...
                    if ($currentValue !== $updatedValue) {
                        ...
                        /*
                            On ne touche pas au nom de l'image, de l'id et des userRoles ici.
                            Le traitement se fait dans le service ou controller approprié.
                        */
                        } elseif (!in_array($propertyName, $excludeProperties)) {
                            ...
                            if (
                                ...
                                && $updatedValue === 'Valeur égale. Aucun changement requis'
                            ) {
            ...
            $responseData[strtolower(basename($entityClassName))] = UtilsService::serializeEntity(
                $entityToUpdate,
                $serializationGroups,
                $this->serializer,
                $entityClassName
